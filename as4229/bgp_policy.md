...
AS4229 support graceful shutdown by default for customer and private peer from 2025.11.
...
The format of a large community follows 4229:73AB:C for 4Byte ASN where:

* C - Neighbor ASN

  * 4Byte public ASN public ASN
...
For example, the standard community "65311:12345" implies that when announcing to neighbors of AS12345 within the North America scope prepend 4229 x 1, the large community "4229:7311:1234567" implies that when announcing to neighbors of AS1234567 within the North America scope prepend 4229 x 1. 
...
* If A = 2, B must equals to 0.
* B cannot be the currently connected region.

Note:

Local preference in AS4229
* Customer route: 1000
* Private peer route: 800
* Transit route: 500
